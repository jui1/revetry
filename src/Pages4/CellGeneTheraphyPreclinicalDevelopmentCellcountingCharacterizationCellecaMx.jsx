...
const CellGeneTheraphyPreclinicalDevelopmentCellcountingCharacterizationCellecaMx = () => {
    ...
    return (
        <div className="stretched">
            <div id="" className="clearfix">
                ...
                {/* Back Button */}
                <div id="back">
                    <Link to="/CellGeneTheraphyPreclinicalDevelopmentCellcountingCharacterization" className="standard-back">
...
export default CellGeneTheraphyPreclinicalDevelopmentCellcountingCharacterizationCellecaMx