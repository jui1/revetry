...
const CellGeneTheraphySamplePreparationSolutionChemagic360 = () => {
  ...
  return (
    <div className="clearfix">
      ...
      <ol className="breadcrumb">
        ...
        <li><Link to="/CellGeneTheraphySamplePreparationSolution">Discovery-Identification to Lead Optimization</Link></li>
...
export default CellGeneTheraphySamplePreparationSolutionChemagic360;
