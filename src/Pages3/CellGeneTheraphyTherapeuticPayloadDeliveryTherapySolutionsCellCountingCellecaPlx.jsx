...
const CellGeneTheraphyTherapeuticPayloadDeliveryTherapySolutionsCellCountingCellecaPlx = () => {
        ...
        <div className="stretched">
          ...
          <div id="" className="clearfix">
            ...
            <li>
              ...
              <li className="active">Cellaca PLX</li>
            </ol>
          </div>
        </div>
      );
...
export default CellGeneTheraphyTherapeuticPayloadDeliveryTherapySolutionsCellCountingCellecaPlx